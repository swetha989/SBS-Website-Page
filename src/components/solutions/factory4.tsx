...
export default function Factory4() {
            ...
            <header className="bg-[#86c2e6] container mx-auto px-12 py-6 relative">
                <div className="flex items-center justify-between px-4 py-4">
                    <div className="flex items-center cursor-pointer">
                        ...
                        <h1 className="text-4xl font-bold text-grey-500">INDUSTRIAL ENGINEERING MANUFACTURING PLANNING</h1>
                    </div>
                    <DropdownMenu>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="space-y-6">
                        <h1 className="text-4xl font-bold">
                            <span className="text-gray-800">Manufacturing Planning</span>
                        </h1>
                        <div className="space-y-4 text-gray-700">
                            <p>Enhance product and resource definitions, define and validate process plans, and create work instructions to achieve production goals. Digital visualization of resource and process changes accelerates time-to-production in any scenario, from any location, leveraging cloud technology.
                            </p>
                        </div>
